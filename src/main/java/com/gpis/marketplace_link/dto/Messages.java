...
public final class Messages {
    ...
    public static final String REPORT_AUTO = "Reporte automático generado. Publicación bajo revisión.";
    public static final String REPORTER_NOT_FOUND = "Reportero no encontrado con id=";
    public static final String PUBLICATION_NOT_FOUND = "Publicacion no encontrada con id=";
    public static final String USER_SYSTEM_NOT_FOUND = "Usuario del sistema no encontrado.";
    public static final String PUBLICATION_UNDER_REVIEW_CANNOT_ADD_REPORT = "La publicacion ya se encuentra bajo revisión, no se puede generar otro reporte.";
